...
OBJS = gameloop.o rendering.o player.o enemy.o grid.o pathfinding.o entity.o asciiMap.o saveload.o structures.o input.o ui.o inventory.o item.o

gameloop.exe: $(OBJS)
	$(CC) -o $@ $(OBJS) $(LDFLAGS)

gameloop.o: gameloop.c gameloop.h rendering.h player.h entity.h enemy.h grid.h pathfinding.h asciiMap.h input.h
