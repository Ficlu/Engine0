...
OBJS = gameloop.o rendering.o player.o enemy.o grid.o pathfinding.o entity.o asciiMap.o saveload.o structures.o input.o ui.o inventory.o item.o texture_coords.o storage.o overlay.o
